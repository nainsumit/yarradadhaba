...
<section id="price" style="background: url("
		../images/blog/blog-bg.jpg");" ng-controller="LoginController">
	<div class="container">
															...
															<div class="col-md-12">
																<div class="block">
																	<h3 class="title wow fadeInLeft"
																		...
																		Login if you <span>have an Account</span>
																	</h3>
																	<p ng-model="loginErrorMessage">{{loginErrorMessage}}</p>
																	<form name="loginForm" ng-submit="loginSubmit()"
																		method='POST'>
																		<div class="form-group wow fadeInDown"
																			data-wow-duration="500ms" data-wow-delay="600ms">
																			<input type="email" name='username' ng-model="user.username"
